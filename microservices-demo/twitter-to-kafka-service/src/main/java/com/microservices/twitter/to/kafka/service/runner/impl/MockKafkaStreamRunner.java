...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    private static final String[] WORDS = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s".split(" ");
    ...
    private String constructRandomTweet(String[] keywords, StringBuilder tweet, int tweetLength) {
        for(int i =0 ; i < tweetLength ; i++){
            ...
            if(i==tweetLength / 2){
                tweet.append(keywords[RANDOM.nextInt(WORDS.length)]).append(" ");
            }
        }
